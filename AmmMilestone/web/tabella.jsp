<%-- 
    Document   : tabella
    Created on : Jun 8, 2016, 11:33:14 PM
    Author     : Matth
--%>
...
<html>
    ...
    <body>
        <table>
            ...
            <tr>
                <th>Death Parade</th>
                <td class="img"><img src="img/deathparade.jpg" title="DP" alt="DP"
             width="150" height="250"></td>
                <td>l Quindecim (クィーン・デキム Kuīn Dekimu?) è un misterioso bar dove lavora un barista solitario di nome Decim. Ogni volta che due persone sulla Terra muoiono allo stesso tempo, esse sono mandate a uno dei molti misteriosi bar come il Quindecim, dove saranno costrette a partecipare al Death Game (デスゲーム Desu Gēmu?), un gioco mortale nel corso del quale i segreti che le hanno portate lì e il loro destino saranno svelati: Decim è infatti uno dei giudici che deciderà se la loro anima sarà reincarnata o finirà nel vuoto.</td>      
                <td>Pezzi disponibili: 41</td>
                <td>Prezzo: 4.49€</td>  
                <td><a class="bottone" href="cliente.html"> Aggiungi al carrello! </a></td>
            </tr>
            ...
            <tr>
                <th>Naruto</th>
                <td class="img"><img src="img/naruto.jpg" title="N" alt="N"
                width="150" height="250"></td>
                ...
                <td>Pezzi disponibili: 13</td>
                <td>Prezzo: 8.99€</td>
                <td><a class="bottone" href="cliente.html"> Aggiungi al carrello! </a></td>
            </tr>
        </table>
        <div style="margin: 0 auto; text-align: center">
        <a class="button" href="login.html"> Pagina del login </a>
        <a class="button" href="descrizione.html"> Pagina della descrizione </a>
        </div>
    </body>
</html>
