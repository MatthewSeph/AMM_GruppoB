...
public class UtentiFactory {
    ...
    private final ArrayList<Oggetti> listaOggetti = new ArrayList<>();
    private final ArrayList<Utente> listaVenditore= new ArrayList<>();
    private final ArrayList<Utente> listaCliente= new ArrayList<>();
